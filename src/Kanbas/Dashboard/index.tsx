...
function Dashboard({ courses, course, setCourse, addNewCourse,
                       deleteCourse, updateCourse } : {courses: Courses[]; course: Courses; setCourse:React.Dispatch<React.SetStateAction<Courses>>; addNewCourse: ()=>void; deleteCourse: (courseId: string)=>void;updateCourse: ()=>void;}
) {
